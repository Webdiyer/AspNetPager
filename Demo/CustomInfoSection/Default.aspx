<%@ Page Language="C#" MasterPageFile="~/NavPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="CustomInfoSection_Default"%>
<asp:Content ID="Content1" ContentPlaceHolderID="main" Runat="Server">
    <div>This sample demonstrate how to display customized paging information along with AspNetPager control.
    </div><br />
