<%@ Page Language="C#" AutoEventWireup="true"  MetaDescription="Search result paging with AspNetPager." CodeFile="Search.aspx.cs" Inherits="Search_Default" MasterPageFile="AspNetPager.master" Title="AspNetPager samples¡ªsearch result paging"%>
