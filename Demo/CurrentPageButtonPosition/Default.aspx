<%@ Page Language="C#" MasterPageFile="~/NavPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="CurrentPageButtonPosition_Default"%>
<asp:Content ID="Content1" ContentPlaceHolderID="main" Runat="Server">

    <div>Set current page button position.
       </div><br />
        <hr /><b>Default (CurrentPageButtonPosition=PagingButtonPosition.Fixed):</b><br />
