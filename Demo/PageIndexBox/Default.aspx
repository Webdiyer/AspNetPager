<%@ Page Language="C#" MasterPageFile="~/NavPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="PageIndexBox_Default"%>
<asp:Content ID="Content1" ContentPlaceHolderID="main" Runat="Server">
    <div>This sample demonstrate how to config AspNetPager control to allow users input or select page index they want to jump to.
    </div><br />
